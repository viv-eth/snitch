...
(
    ...
    output logic             [ 8:0] m_axi_pcie_awuser,
    ...
    output logic             [ 8:0] m_axi_pcie_wuser,
    ...
    output logic             [ 8:0] m_axi_pcie_aruser,
    ...
    input  logic             [ 8:0] m_axi_pcie_ruser,
    ...
    input  logic             [ 8:0] m_axi_pcie_buser,
    ...
    input  logic             [ 8:0] s_axi_pcie_awuser,
    ...
    input  logic             [ 8:0] s_axi_pcie_wuser,
    ...
    input  logic             [ 8:0] s_axi_pcie_aruser,
    ...
    output logic             [ 8:0] s_axi_pcie_ruser,
    ...
    output logic             [ 8:0] s_axi_pcie_buser
    /// HBI Ports
);
  ...
  // PCIe //
  //////////
  axi_a48_d64_i8_u9_req_t  pcie_axi_req_o;
  axi_a48_d64_i8_u9_resp_t pcie_axi_rsp_i;

  axi_a48_d64_i4_u9_req_t  pcie_axi_req_i;
  axi_a48_d64_i4_u9_resp_t pcie_axi_rsp_o;
